...
namespace safecrowd::domain {
    ...
    FacilityLayout2D DemoFixtureService::createSprint1DemoLayout() const {
        ...
        // 4. 장애물 (방 한가운데 위치한 4x1 크기의 벽. 에이전트 회피 테스트용)
        ...
        // 5. 스폰 구역 (좌측 하단, 100명 스폰)
        SpawnZone2D spawnArea;
        spawnArea.id = "spawn-1";
        spawnArea.targetAgentCount = 100; // Sprint 1 데모 요구사항
