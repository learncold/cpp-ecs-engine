...
| US-15~US-17 결과 시각화 및 비교 | `ScenarioSimulationRunner`, `SimulationFrame`, 향후 Result UI, 히트맵 레이어, 비교 요약 뷰 | live run frame 읽기 경로는 마련됐고, persisted 결과 뷰와 비교 UI는 application layer 후속 작업으로 유지 |
