...
- 우측 패널에 recognition quality, inspector, approval 상태 표시
...
- 중앙 Layout Preview
- 우측 Recognition Quality 요약
- 우측 선택 inspector
- 우측 approval action
- 하단 review 상태 영역

현재 Recognition Quality 표시 대상:

- trace coverage
- traced element count / 전체 layout element count
- blocking issue count
- warning issue count
- confidence score와 상태 문구
...
- issue 해결/무시/승인 상태
- 인식 품질 score 산식의 product 기준화
- recognition quality 변화 이력 표시
- reimport 이후 기존 보정과 recognition 품질 비교
...
9. Recognition Quality 기준 product화
10. Run Workspace batch/readiness 확장
11. Analysis Workspace 확장
